...
return [
    ...
    'phone_default_countries' => 'Неверно введен номер телефона',
    ...
    'is_youtube_link' => 'Поле ":attribute" должно содержать ссылку на YouTube видео',
    'file_exists' => 'Не удалось загрузить файл в поле ":attribute"',
    'child_field_required_if' => 'Неверные параметры в пользовательской валидации для поля :attribute',
    'external_links' => 'Поле :attribute не должно содержать внешних ссылок',
    'seo_rule_url_route_not_in' => 'Поле :attribute не может иметь данный url, т.к. заменяет SEO сущности, у которой делать это здесь запрещено',
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => 'Адрес',
        'phone' => 'Телефон',
        'phone_default_countries' => 'Телефон',
        'mobile' => 'Моб. номер',
        'age' => 'Возраст',
        'sex' => 'Пол',
        'gender' => 'Пол',
