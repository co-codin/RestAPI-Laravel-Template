...
class AchievementDatabaseSeeder extends Seeder
{
    ...
    protected function achievements() : array
    {
        return [
            ...
            ["name" => "Финалист “Предприниматель года 2019” от EY","is_enabled" => true, "image" => "/img/about-progress6.png"],
            ["name" => "Победитель “Выбор делового интернета” от BFM","is_enabled" => true, "image" => "/img/about-progress7.png"],
